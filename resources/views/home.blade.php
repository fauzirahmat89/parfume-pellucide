...
@section('meta_title', 'Pellucide | Skincare Premium untuk Iklim Tropis')
@section('meta_description', 'Pellucide: skincare terinspirasi Korea untuk kulit tropis Indonesia. Lihat hot products, katalog lengkap, dan beli via Shopee, Tokopedia, atau WhatsApp.')
@section('meta_image', asset('images/placeholder-product.svg'))
...
@section('content')
    ...
    <section id="hot-products" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="section-subtitle mt-2">Pilihan produk unggulan kami.</p>
            </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="section-heading">Koleksi Favorit</h2>
                <p class="section-subtitle mt-2">Pilih cepat dari rangkaian best choice Pellucide.</p>
            </div>
        </div>
        ...
        <div class="glass-panel rounded-3xl p-8 md:p-12 grid md:grid-cols-2 gap-10">
            ...
            <div class="glass-panel rounded-3xl p-6 border-white/10">
                ...
                <div class="mt-8 space-y-3 text-sm text-gray-300">
                    ...
                    <p>- Status HOT maksimal 3 produk ditampilkan di beranda.</p>
                </div>
            </div>
        </div>
    </section>
